      ...
      {stats && (
        <>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
              {(
                ...
                return (
                  <div
                    key={key}
                    className="flex flex-col items-center gap-1 p-3 rounded-xl bg-slate-50 border border-slate-100"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            ...
            {stats.recent_incidents.length === 0 ? (
              <div className="px-6 py-12 text-center">
                ...
                <Link href="/" className="text-blue-600 text-sm underline mt-2 inline-block">
          ...
          {(stats.avg_triage_ms != null || stats.avg_ticket_ms != null) && (
            <div className="flex flex-wrap gap-6 px-1 text-xs text-slate-400">
              {stats.avg_triage_ms != null && (
                <span>
                  Avg AI triage:{' '}
